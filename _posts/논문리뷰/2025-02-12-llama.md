...
# Instruction
 ...
 이 연구진들은 기존의 모델들과 달리 공개된 데이터만 사용해 작업했고, 오픈 소싱과 호환되는 모델을 만들었다. OPT, GPT-NeoX, BLOOM, GLM등의 예외 모델들도 있지만, 이들은 Chinchilla와 PaLM-540B와 경쟁하지 못 한다.
...
###  ![LLaMA_Table1_Pre_training_data](../assets/img/2025-02-12-llama/LLaMA_Table1_Pre_training_data.png)        
...
<img src="../assets/img/2025-02-12-llama/LLama_architecture_devopedia.org_llama-llm-1739596207129-2.png" alt="LLama_architecture_devopedia.org_llama-llm" style="zoom:80%;" />
...
### SwiGLU Activation Function [PaLM]
 ...
 Relu 비선형 함수를 성능 향상을 위해 SwiGLU활성화 함수로 교체하였고, PaLM에서 사용한 4d대신 $$\frac{2}{3}\d$$차원을 사용했다.
...
## 3. Optimizer
 ...
 ![LLaMA_Table2_hyperparameters](../assets/img/2025-02-12-llama/LLaMA_Table2_hyperparameters.png)
...
![LLaMA_Table4n5](../assets/img/2025-02-12-llama/LLaMA_Table4n5-1739609221446-16.png)

### 3. Reading Comprehension

다음은 중국 중,고등학생 시험 독해력의 밴치마크 결과이다.

![LLaMA_Table6](../assets/img/2025-02-12-llama/LLaMA_Table6-1739609251549-18.png)

### 4. Mathematical Reasoning

다음은 수학적 추론 MATH와 GSM8k밴치마크 결과이다. 

![LLaMA_Table7](../assets/img/2025-02-12-llama/LLaMA_Table7-1739609257495-20.png)

### 5. Code Generation

다음은 코드를 작성관련 HumanEval과 MBPP를 밴치마크 결과이다.

![LLaMA_Table8](../assets/img/2025-02-12-llama/LLaMA_Table8-1739609277423-22.png)

### 6. Massive Multitask Language Understanding

다음은 대규모 다중작업 언어 이해 Humanities, STEM, Social Sciences와 그외의 밴치마크 결과이다.

![LLaMA_Table9](../assets/img/2025-02-12-llama/LLaMA_Table9-1739609296987-24.png)

### 7. Evolution of Performance During Training

 다음은 모델의 크기별 훈련 토큰에 따른 훈련 손실(Training loss)의 상관 관계를 보여주는 그래프이다. 

![LLaMA_Figure1](../assets/img/2025-02-12-llama/LLaMA_Figure1-1739609392001-26.png)
...
![LLaMA_Figure2](../assets/img/2025-02-12-llama/LLaMA_Figure2.png)
